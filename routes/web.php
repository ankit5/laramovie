...
Route::middleware('page-cache')->get('/search', 'MoviesController@search2')->name('movies.search2');
...
Route::middleware('page-cache')->get('/movies/{id}', 'MoviesController@show')->name('movies.show');
