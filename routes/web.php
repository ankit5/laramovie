...
Route::middleware('page-cache')->get('/english-series', 'MoviesController@englishseries')->name('movies.englishseries');
Route::middleware('page-cache')->get('/english-series/{page}', 'MoviesController@englishseries')->name('movies.englishseries');
