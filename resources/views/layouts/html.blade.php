...
<link rel="stylesheet" id="style-css" href="{{ asset('wp-content/themes/moviewp/style.css') }}" type="text/css" media="all">
<link rel="stylesheet" id="color-css" href="{{ asset('wp-content/themes/moviewp/assets/css/red.css') }}" type="text/css" media="all">
<link rel="stylesheet" id="flickity-css" href="{{ asset('wp-content/themes/moviewp/assets/css/flickity.css') }}" type="text/css" media="all">
...
<script type="text/javascript" src="{{ asset('wp-content/themes/moviewp/assets/js/vendor.js') }}" id="vendor-js"></script>
