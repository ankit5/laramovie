...
jQuery(".carousel-cell a span.tt, .carousel-cell a span.ep, .carousel-cell a span.item-tv, .carousel-cell a span.episodes, .carousel-cell .flag").delay(500).fadeIn(500);jQuery(function(){var e=jQuery(".item_container");$(document).on("click",".item_container",function(){$(this).attr("id");jQuery(".item_container").removeClass("expanded"),jQuery(this).addClass("expanded"),clearInterval(r)}),jQuery(".ul_container").hover(function(){clearInterval(r)});var r,t=1;r=setInterval(function(){jQuery(".item_container").removeClass("expanded"),jQuery(e[t]).addClass("expanded"),10==(t+=1)&&(t=0)},1e4)}),jQuery("img#logos").on("error",function(){var e=jQuery(this).attr("data-title");jQuery(this).attr("src","//via.placeholder.com/185x104/111111/FFFFFF/?text="+e)});
